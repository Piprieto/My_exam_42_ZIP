...
Queremos convertir un int en una cadena de char. Un int son 64 bytes (32 bits) así que permite almacenar 
valores entre -2147483648 y 2147483647. Si le damos a la func como argumento un número mayor dará error y 
los dos números límites tampoco saldrán correctamente pq hay que tratarlos diferente. Así que aunque el 
arg de la función que nos piden es int, lo cambiaremos a long int permitiendo almacenar valores mucho mayores.
